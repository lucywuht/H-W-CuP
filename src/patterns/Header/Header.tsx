...
function ResponsiveHeaderDesktop({ cartCount: cartCountProp, cartPrice: cartPriceProp }: ResponsiveHeaderDesktopProps = {}) {
...
function ResponsiveHeaderMobile({ cartCount: cartCountProp, cartPrice: cartPriceProp }: ResponsiveHeaderMobileProps = {}) {
  const [searchQuery, setSearchQuery] = useState('');
  const { cartCount, cartPrice } = useHeaderCartSnapshot(cartCountProp, cartPriceProp);
