...
>((props, ref) => {
  ...
  const classes = cx('ld-button-button', variant === 'destructive' && 'ld-button-destructive', variant === 'ghost' && 'ld-button-ghost', variant === 'primary' && 'ld-button-primary', variant === 'secondary' && 'ld-button-secondary', variant === 'tertiary' && 'ld-button-tertiary', variant === 'topnav-action-alt' && 'ld-button-topnav-action-alt', isFullWidth && 'ld-button-isFullWidth', isLoading && 'ld-button-loading', size === 'large' && 'ld-button-large', size === 'medium' && 'ld-button-medium', size === 'small' && 'ld-button-small', className);
