...
export const Rating = React.forwardRef<HTMLDivElement, RatingProps>((props, ref) => {
  ...
  return (
    ...
    >
      ...
      {/* AT-only live region: announces only the committed value, not
          hover/focus previews — keyboard users scrubbing arrow keys would
          otherwise hear every intermediate star. */}
      <span className="ld-wcp-rating-live" aria-live="polite" aria-atomic="true">
