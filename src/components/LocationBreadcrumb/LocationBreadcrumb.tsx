 ...
 * or run `npx ld-kit show LocationBreadcrumb`.
 */
...
export function LocationBreadcrumb({
  ...
  return (
    <div className={cx('ax-location-breadcrumb', className)} style={style}>
      ...
      {count !== undefined ? (
        <span className="ax-location-breadcrumb__count" aria-live="polite">
          {countLoading ? (
            <span className="ax-location-breadcrumb__count-loading" aria-label="Loading count">
