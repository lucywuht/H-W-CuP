 ...
 * or run `npx ld-kit show A11yDevAssertions`.
 */
...
export function A11yDevAssertions(): JSX.Element | null {
  ...
  React.useEffect(() => {
    ...
    // Blocking modal disabled — fires false positives during design iteration and blocks prototype interaction (see #a11y-checker Slack thread, 2026-06-02).
    return;
