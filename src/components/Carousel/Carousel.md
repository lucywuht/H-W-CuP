...
`Carousel` is part of a compound component. Use together with: `CarouselContent`, `CarouselItem`, `CarouselPrevious`, `CarouselNext`, `CarouselPagination`, `CarouselProgressBar`.
