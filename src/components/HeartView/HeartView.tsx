 ...
 * or run `npx ld-kit show HeartView`.
 */
...
export const HeartView: React.FunctionComponent<HeartViewProps> = (props) => {
  ...
  invariant(
    ...
    '`HeartView` accessibility violation. If `aria-label` is provided it must be a non-empty string. Omit it to use the default "Add to favorites" / "Remove from favorites" label.',
  );
