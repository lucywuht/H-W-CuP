 ...
 * or run `npx ld-kit show RichMediaSheet`.
 */
...
function SheetHeader({variant, title, subtitle, logoSlot, onClose, forceInverse = false}: {variant: RichMediaSheetHeaderVariant; title?: string; subtitle?: string; logoSlot?: React.ReactNode; onClose: () => void; forceInverse?: boolean}) {
  if (variant === 'none') {
    return (
