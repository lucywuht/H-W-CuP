...
export class StockChart extends Container {
    constructor() {
         ...
         */
        this.panels = new ListAutoDispose();
        /**
         * A list of indicators on chart.
         *
         * @see {@link https://www.amcharts.com/docs/v5/charts/stock/indicators/} for more info
         */
        this.indicators = new ListAutoDispose();
        /**
         ...
         */
        this.toolsContainer = this.children.push(Container.new(this._root, { width: p100, themeTags: [] }));
        /**
         * A [[Container]] where all the stock panels are placed into.
         *
         * @default Container.new()
         */
        this.panelsContainer = this.children.push(Container.new(this._root, { width: p100, height: p100, layout: this._root.verticalLayout, themeTags: ["chartscontainer"] }));
        /**
         ...
         * @since 5.7.0
         */
        this.spriteResizer = this.children.push(SpriteResizer.new(this._root, {}));
    }
    _afterNew() {
...
StockChart.className = "StockChart";
StockChart.classNames = Container.classNames.concat([StockChart.className]);
/**
