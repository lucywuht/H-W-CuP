...
export declare class XYCursor extends Container {
    ...
    protected _handleLineMove(key: string, ctrlKey?: boolean): void;
    protected _handleLineFocus(): void;
    protected _handleLineBlur(): void;
