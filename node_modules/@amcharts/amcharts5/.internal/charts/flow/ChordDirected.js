...
export class ChordDirected extends Chord {
    constructor() {
        super(...arguments);
        this._d3chord = chordDirected();
        this._ribbonArrow = ribbonArrow();
        /**
         * List of link elements.
         *
         * @default new ListTemplate<ChordLinkDirected>
         */
        this.links = this.addDisposer(new ListTemplate(Template.new({}), () => ChordLinkDirected._new(this._root, { themeTags: ["link", "shape"] }, [this.links.template])));
    }
    /**
     * @ignore
     */
...
ChordDirected.className = "ChordDirected";
ChordDirected.classNames = Chord.classNames.concat([ChordDirected.className]);
