...
export class GanttSeries extends ColumnSeries {
    constructor() {
         ...
         */
        this.connectorLine = this.children.push(Line.new(this._root, {
         ...
         * a connector.
         */
        this.connectorArrow = this.children.push(Triangle.new(this._root, {
         ...
         */
        this.links = this.addDisposer(new ListTemplate(Template.new({}), () => Link._new(this._root, {
         ...
         */
        this.containers = this.addDisposer(new ListTemplate(Template.new({}), () => Container._new(this._root, {
            position: "absolute",
         ...
         */
        this.maskedContainers = this.addDisposer(new ListTemplate(Template.new({}), () => Container._new(this._root, {
            position: "absolute",
         ...
         */
        this.startBullets = this.addDisposer(new ListTemplate(Template.new({}), () => Circle._new(this._root, {
            x: -1000,
         ...
         */
        this.endBullets = this.addDisposer(new ListTemplate(Template.new({}), () => Circle._new(this._root, {
            x: -1000,
         ...
         */
        this.startGrips = this.addDisposer(new ListTemplate(Template.new({}), () => Rectangle._new(this._root, {
            themeTagsSelf: ["resizegrip", "start"]
        }, [this.startGrips.template])));
        /**
         * [[ListTemplate]] of [[Rectangle]]s that are used to resize task bars.
         */
        this.endGrips = this.addDisposer(new ListTemplate(Template.new({}), () => Rectangle._new(this._root, {
         ...
         * zero-duration tasks.
         */
        this.zeroRectangles = this.addDisposer(new ListTemplate(Template.new({}), () => RoundedRectangle._new(this._root, {
         ...
         */
        this.progressRectangles = this.addDisposer(new ListTemplate(Template.new({}), () => Rectangle._new(this._root, {
         ...
         * rectangles.
         */
        this.progressGrips = this.addDisposer(new ListTemplate(Template.new({}), () => Triangle._new(this._root, {
...
GanttSeries.className = "GanttSeries";
GanttSeries.classNames = ColumnSeries.classNames.concat([GanttSeries.className]);
