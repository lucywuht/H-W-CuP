...
export class PictorialStackedSeries extends PyramidSeries {
    constructor() {
         ...
         */
        this.seriesMask = Graphics.new(this._root, { position: "absolute", x: p50, y: p50, centerX: p50, centerY: p50 });
        this.seriesGraphics = this.slicesContainer.children.push(Graphics.new(this._root, { themeTags: ["pictorial", "background"], position: "absolute", x: p50, y: p50, centerX: p50, centerY: p50 }));
    }
    _afterNew() {
        super._afterNew();
...
PictorialStackedSeries.classNames = PyramidSeries.classNames.concat([PictorialStackedSeries.className]);
