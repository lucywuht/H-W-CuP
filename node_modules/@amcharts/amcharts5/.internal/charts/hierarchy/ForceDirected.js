...
export class ForceDirected extends LinkedHierarchy {
    constructor() {
         ...
         * @ignore
         */
        this.collisionForce = d3Force.forceCollide(20);
        /**
         * @ignore
         */
        this.linkForce = d3Force.forceLink();
        this._nodes = [];
        this._links = [];
        this._tick = 0;
...
ForceDirected.className = "ForceDirected";
ForceDirected.classNames = LinkedHierarchy.classNames.concat([ForceDirected.className]);
