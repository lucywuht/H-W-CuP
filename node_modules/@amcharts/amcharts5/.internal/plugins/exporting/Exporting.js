...
export class Exporting extends Entity {
    ...
    getPDF(customOptions, includeImage = true, includeData = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Create PDF
            return yield pdfmake.createPdf(doc, {}).getBase64();
        });
    }
    /**
     * @ignore
...
Exporting.className = "Exporting";
Exporting.classNames = Entity.classNames.concat([Exporting.className]);
