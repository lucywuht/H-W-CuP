...
export declare abstract class Settings implements IDisposer, IAnimation, IStartAnimation {
    ...
    _debouncedSettingEvents: {
        [K in keyof this["_settings"]]?: Array<{
            cb: (value: any, target?: any, key?: any) => void;
            delay: number;
            timeout?: number;
        }>;
    };
    _debouncedPrivateSettingEvents: {
        [K in keyof this["_settings"]]?: Array<{
            cb: (value: any, target?: any, key?: any) => void;
            delay: number;
            timeout?: number;
    ...
    private _onDebouncedHelper;
    private _offDebouncedHelper;
    /**
     ...
     * @return                 Disposer for event
     */
    onDebounced<Key extends keyof this["_settings"]>(key: Key, callback: (value: this["_settings"][Key], target?: this, key?: Key) => void, debounceDelay: number): IDisposer;
    /**
     ...
     * @param   callback  Callback
     */
    offDebounced<Key extends keyof this["_settings"]>(key: Key, callback?: (value: this["_settings"][Key], target?: this, key?: Key) => void): void;
    /**
     ...
     * @return                 Disposer for event
     */
    onPrivateDebounced<Key extends keyof this["_privateSettings"]>(key: Key, callback: (value: this["_privateSettings"][Key], target?: this, key?: Key) => void, debounceDelay: number): IDisposer;
    /**
     ...
     * @param   callback  Callback
     */
    offDebouncedPrivate<Key extends keyof this["_privateSettings"]>(key: Key, callback?: (value: this["_privateSettings"][Key], target?: this, key?: Key) => void): void;
    /**
     * @ignore
     */
